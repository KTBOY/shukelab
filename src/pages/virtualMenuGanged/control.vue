  ...
  <view class="demo-page">
    ...
    <view class="control-bar">
      ...
      <view class="control-bar__row">
        ...
        <switch :checked="virtualEnabled" color="#ff5339" style="transform: scale(0.7)" @change="onVirtualChange" />
...
import type {
  ...
  ChangePayload,
  SkLinkageMenuExpose,
} from '@/uni_modules/sk-linkage-menu/components/sk-linkage-menu/sk-linkage-menu.types'
